...
urlpatterns = [
    ...
    path('staff/students/<int:student_id>/edit/', views.edit_student_view, name='edit_student_view'),
    path('staff/students/<int:student_id>/delete/', views.delete_student_view, name='delete_student_view'),
